## If anything force-closes or messes up, you MIGHT need to deodex some files... 
...
# FINGERPRINT
# Comment out GfxEngine.apk because Photon did not have one...
PRODUCT_COPY_FILES += \
    vendor/motorola/sunfire/proprietary/lib/libAuthUDMDrv_1750A100.so:system/lib/libAuthUDMDrv_1750A100.so \
    vendor/motorola/sunfire/proprietary/lib/libam2app.so:system/lib/libam2app.so \
    vendor/motorola/sunfire/proprietary/lib/libam2server.so:system/lib/libam2server.so \
    vendor/motorola/sunfire/proprietary/bin/am2server:system/bin/am2server \
    # vendor/motorola/sunfire/proprietary/app/GfxEngine.apk:system/app/GfxEngine.apk \
    vendor/motorola/sunfire/proprietary/etc/am2server.pubkey:system/etc/am2server.pubkey \
...
# Bin
# Comment out ftmipcd and whisperd because Photon didn't have it
PRODUCT_COPY_FILES += \
...
# Wifi/bt firmware
# Change vendor/motorola/sunfire/proprietary/etc/BCM4329B1_002.002.023.0757.0780.hcd:system/etc/BCM4329B1_002.002.023.0757.0780.hcd to 
...
# Comment out FastDormancy.apk because Photon doesn't seem to need it
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
    ...
    vendor/motorola/sunfire/proprietary/lib/libextdisp.so:system/lib/libextdisp.so \
...
# HDMI
# Comment out MirrorService.apk because Photon does not have one...
PRODUCT_COPY_FILES += \
    vendor/motorola/sunfire/proprietary/framework/com.motorola.android.iextdispservice.jar:system/framework/com.motorola.android.iextdispservice.jar \
    vendor/motorola/sunfire/proprietary/framework/com.motorola.android.imirrorservice.jar:system/framework/com.motorola.android.imirrorservice.jar \
    vendor/motorola/sunfire/proprietary/lib/libmirrorjni.so:system/lib/libmirrorjni.so \
    vendor/motorola/sunfire/proprietary/etc/permissions/com.motorola.android.iextdispservice.xml:system/etc/permissions/com.motorola.android.iextdispservice.xml \
    vendor/motorola/sunfire/proprietary/etc/permissions/com.motorola.android.imirrorservice.xml:system/etc/permissions/com.motorola.android.imirrorservice.xml \
    # vendor/motorola/sunfire/proprietary/app/MirrorService.apk:system/app/MirrorService.apk
