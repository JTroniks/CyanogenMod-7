...
class V8CharacterData {
 ...
 public:
  ...
  static CharacterData* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(CharacterData*);
  ...
  v8::Handle<v8::Value> toV8(CharacterData*);
  v8::Handle<v8::Value> toV8(PassRefPtr<CharacterData >);
}
