...
class V8HTMLObjectElement {
 ...
 public:
  ...
  static HTMLObjectElement* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(HTMLObjectElement*);
  ...
  v8::Handle<v8::Value> toV8(HTMLObjectElement*);
  v8::Handle<v8::Value> toV8(PassRefPtr<HTMLObjectElement >);
}
