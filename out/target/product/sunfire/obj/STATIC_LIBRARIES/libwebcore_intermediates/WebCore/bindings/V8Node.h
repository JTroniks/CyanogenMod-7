...
class V8Node {
 ...
 public:
  ...
  static Node* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(Node*, bool forceNewObject = false);
  ...
  static v8::Handle<v8::Value> isSameNodeCallback(const v8::Arguments&);
  static v8::Handle<v8::Value> isEqualNodeCallback(const v8::Arguments&);
  static v8::Handle<v8::Value> lookupPrefixCallback(const v8::Arguments&);
  static v8::Handle<v8::Value> isDefaultNamespaceCallback(const v8::Arguments&);
  static v8::Handle<v8::Value> lookupNamespaceURICallback(const v8::Arguments&);
  static v8::Handle<v8::Value> compareDocumentPositionCallback(const v8::Arguments&);
  ...
  v8::Handle<v8::Value> toV8(Node*, bool forceNewObject = false);
  v8::Handle<v8::Value> toV8(PassRefPtr<Node >, bool forceNewObject = false);
}
