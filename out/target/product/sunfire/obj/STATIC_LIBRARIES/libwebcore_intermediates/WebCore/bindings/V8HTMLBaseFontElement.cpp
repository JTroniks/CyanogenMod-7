...
static const BatchedAttribute HTMLBaseFontElement_attrs[] = {
    {
        // Attribute 'color' (Type: 'attribute' ExtAttr: 'ConvertNullToNullString Reflect')
        "color",
        HTMLBaseFontElementInternal::colorAttrGetter,
        HTMLBaseFontElementInternal::colorAttrSetter,
    ...
    {
        // Attribute 'face' (Type: 'attribute' ExtAttr: 'ConvertNullToNullString Reflect')
        "face",
        HTMLBaseFontElementInternal::faceAttrGetter,
        HTMLBaseFontElementInternal::faceAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "size",
        HTMLBaseFontElementInternal::sizeAttrGetter,
        HTMLBaseFontElementInternal::sizeAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLBaseFontElementTemplate(v8::Persistent<v8::FunctionTemplate> desc) {
  v8::Local<v8::Signature> default_signature = configureTemplate(desc, "HTMLBaseFontElement",
      V8HTMLElement::GetTemplate(), V8HTMLBaseFontElement::internalFieldCount,
      HTMLBaseFontElement_attrs, sizeof(HTMLBaseFontElement_attrs)/sizeof(*HTMLBaseFontElement_attrs),
      NULL, 0);
...
v8::Persistent<v8::FunctionTemplate> V8HTMLBaseFontElement::GetRawTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLBaseFontElement_raw_cache_ = createRawTemplate();
  return V8HTMLBaseFontElement_raw_cache_;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLBaseFontElement::GetTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLBaseFontElement_cache_ = ConfigureV8HTMLBaseFontElementTemplate(GetRawTemplate());
  return V8HTMLBaseFontElement_cache_;
}
...
v8::Handle<v8::Object> V8HTMLBaseFontElement::wrap(HTMLBaseFontElement* impl) {
  ...
  if (!context.IsEmpty())
    context->Enter();
  wrapper = V8DOMWrapper::instantiateV8Object(proxy, V8ClassIndex::HTMLBASEFONTELEMENT, impl);
