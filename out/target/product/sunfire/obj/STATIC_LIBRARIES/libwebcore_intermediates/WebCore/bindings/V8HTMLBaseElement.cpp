...
static const BatchedAttribute HTMLBaseElement_attrs[] = {
    {
        // Attribute 'href' (Type: 'attribute' ExtAttr: 'ConvertNullToNullString Reflect')
        "href",
        HTMLBaseElementInternal::hrefAttrGetter,
        HTMLBaseElementInternal::hrefAttrSetter,
    ...
    },
    {
        ...
        "target",
        HTMLBaseElementInternal::targetAttrGetter,
        HTMLBaseElementInternal::targetAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLBaseElementTemplate(v8::Persistent<v8::FunctionTemplate> desc) {
  v8::Local<v8::Signature> default_signature = configureTemplate(desc, "HTMLBaseElement",
      V8HTMLElement::GetTemplate(), V8HTMLBaseElement::internalFieldCount,
      HTMLBaseElement_attrs, sizeof(HTMLBaseElement_attrs)/sizeof(*HTMLBaseElement_attrs),
      NULL, 0);
...
v8::Persistent<v8::FunctionTemplate> V8HTMLBaseElement::GetRawTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLBaseElement_raw_cache_ = createRawTemplate();
  return V8HTMLBaseElement_raw_cache_;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLBaseElement::GetTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLBaseElement_cache_ = ConfigureV8HTMLBaseElementTemplate(GetRawTemplate());
  return V8HTMLBaseElement_cache_;
}
...
v8::Handle<v8::Object> V8HTMLBaseElement::wrap(HTMLBaseElement* impl) {
  ...
  if (!context.IsEmpty())
    context->Enter();
  wrapper = V8DOMWrapper::instantiateV8Object(proxy, V8ClassIndex::HTMLBASEELEMENT, impl);
