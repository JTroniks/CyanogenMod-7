...
class V8HTMLSelectElement {
 ...
 public:
  ...
  static HTMLSelectElement* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(HTMLSelectElement*);
  ...
  v8::Handle<v8::Value> toV8(HTMLSelectElement*);
  v8::Handle<v8::Value> toV8(PassRefPtr<HTMLSelectElement >);
}
