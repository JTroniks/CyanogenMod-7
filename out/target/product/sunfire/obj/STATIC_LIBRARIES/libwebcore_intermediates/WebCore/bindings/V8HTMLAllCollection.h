...
class V8HTMLAllCollection {
 ...
 public:
  ...
  static HTMLAllCollection* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(HTMLAllCollection*);
  static v8::Handle<v8::Value> itemCallback(const v8::Arguments&);
  static v8::Handle<v8::Value> namedItemCallback(const v8::Arguments&);
  static v8::Handle<v8::Value> tagsCallback(const v8::Arguments&);
  ...
  v8::Handle<v8::Value> toV8(HTMLAllCollection*);
  v8::Handle<v8::Value> toV8(PassRefPtr<HTMLAllCollection >);
}
