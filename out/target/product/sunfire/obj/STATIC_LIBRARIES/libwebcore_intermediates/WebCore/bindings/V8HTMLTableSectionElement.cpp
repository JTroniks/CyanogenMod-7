...
static const BatchedAttribute HTMLTableSectionElement_attrs[] = {
    {
        // Attribute 'align' (Type: 'attribute' ExtAttr: 'ConvertNullToNullString')
        "align",
        HTMLTableSectionElementInternal::alignAttrGetter,
        HTMLTableSectionElementInternal::alignAttrSetter,
    ...
    },
    {
        ...
        "ch",
        HTMLTableSectionElementInternal::chAttrGetter,
        HTMLTableSectionElementInternal::chAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "chOff",
        HTMLTableSectionElementInternal::chOffAttrGetter,
        HTMLTableSectionElementInternal::chOffAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "vAlign",
        HTMLTableSectionElementInternal::vAlignAttrGetter,
        HTMLTableSectionElementInternal::vAlignAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "rows",
        HTMLTableSectionElementInternal::rowsAttrGetter,
        0,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
...
static const BatchedCallback HTMLTableSectionElement_callbacks[] = {
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLTableSectionElementTemplate(v8::Persistent<v8::FunctionTemplate> desc) {
  v8::Local<v8::Signature> default_signature = configureTemplate(desc, "HTMLTableSectionElement",
      V8HTMLElement::GetTemplate(), V8HTMLTableSectionElement::internalFieldCount,
      HTMLTableSectionElement_attrs, sizeof(HTMLTableSectionElement_attrs)/sizeof(*HTMLTableSectionElement_attrs),
      HTMLTableSectionElement_callbacks, sizeof(HTMLTableSectionElement_callbacks)/sizeof(*HTMLTableSectionElement_callbacks));
...
v8::Persistent<v8::FunctionTemplate> V8HTMLTableSectionElement::GetRawTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLTableSectionElement_raw_cache_ = createRawTemplate();
  return V8HTMLTableSectionElement_raw_cache_;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLTableSectionElement::GetTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLTableSectionElement_cache_ = ConfigureV8HTMLTableSectionElementTemplate(GetRawTemplate());
  return V8HTMLTableSectionElement_cache_;
}
...
v8::Handle<v8::Object> V8HTMLTableSectionElement::wrap(HTMLTableSectionElement* impl, bool forceNewObject) {
  ...
  if (!context.IsEmpty())
    context->Enter();
  wrapper = V8DOMWrapper::instantiateV8Object(proxy, V8ClassIndex::HTMLTABLESECTIONELEMENT, impl);
