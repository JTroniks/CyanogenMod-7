...
static const BatchedAttribute HTMLDivElement_attrs[] = {
    {
        // Attribute 'align' (Type: 'attribute' ExtAttr: 'ConvertNullToNullString')
        "align",
        HTMLDivElementInternal::alignAttrGetter,
        HTMLDivElementInternal::alignAttrSetter,
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLDivElementTemplate(v8::Persistent<v8::FunctionTemplate> desc) {
  v8::Local<v8::Signature> default_signature = configureTemplate(desc, "HTMLDivElement",
      V8HTMLElement::GetTemplate(), V8HTMLDivElement::internalFieldCount,
      HTMLDivElement_attrs, sizeof(HTMLDivElement_attrs)/sizeof(*HTMLDivElement_attrs),
      NULL, 0);
...
v8::Persistent<v8::FunctionTemplate> V8HTMLDivElement::GetRawTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLDivElement_raw_cache_ = createRawTemplate();
  return V8HTMLDivElement_raw_cache_;
}
...
v8::Handle<v8::Object> V8HTMLDivElement::wrap(HTMLDivElement* impl) {
  ...
  if (!context.IsEmpty())
    context->Enter();
  wrapper = V8DOMWrapper::instantiateV8Object(proxy, V8ClassIndex::HTMLDIVELEMENT, impl);
