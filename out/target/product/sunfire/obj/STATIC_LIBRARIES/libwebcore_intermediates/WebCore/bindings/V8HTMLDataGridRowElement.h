...
class V8HTMLDataGridRowElement {
 ...
 public:
  ...
  static HTMLDataGridRowElement* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(HTMLDataGridRowElement*);
  static const int cacheIndex = v8DefaultWrapperInternalFieldCount + 0;
  static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
};

  v8::Handle<v8::Value> toV8(HTMLDataGridRowElement*);
  v8::Handle<v8::Value> toV8(PassRefPtr<HTMLDataGridRowElement >);
}
