...
static const BatchedAttribute HTMLHRElement_attrs[] = {
    {
        // Attribute 'align' (Type: 'attribute' ExtAttr: 'ConvertNullToNullString')
        "align",
        HTMLHRElementInternal::alignAttrGetter,
        HTMLHRElementInternal::alignAttrSetter,
    ...
    {
        // Attribute 'noShade' (Type: 'attribute' ExtAttr: '')
        "noShade",
        HTMLHRElementInternal::noShadeAttrGetter,
        HTMLHRElementInternal::noShadeAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "size",
        HTMLHRElementInternal::sizeAttrGetter,
        HTMLHRElementInternal::sizeAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "width",
        HTMLHRElementInternal::widthAttrGetter,
        HTMLHRElementInternal::widthAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLHRElementTemplate(v8::Persistent<v8::FunctionTemplate> desc) {
  v8::Local<v8::Signature> default_signature = configureTemplate(desc, "HTMLHRElement",
      V8HTMLElement::GetTemplate(), V8HTMLHRElement::internalFieldCount,
      HTMLHRElement_attrs, sizeof(HTMLHRElement_attrs)/sizeof(*HTMLHRElement_attrs),
      NULL, 0);
...
v8::Persistent<v8::FunctionTemplate> V8HTMLHRElement::GetRawTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLHRElement_raw_cache_ = createRawTemplate();
  return V8HTMLHRElement_raw_cache_;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLHRElement::GetTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLHRElement_cache_ = ConfigureV8HTMLHRElementTemplate(GetRawTemplate());
  return V8HTMLHRElement_cache_;
}
...
v8::Handle<v8::Object> V8HTMLHRElement::wrap(HTMLHRElement* impl) {
  ...
  if (!context.IsEmpty())
    context->Enter();
  wrapper = V8DOMWrapper::instantiateV8Object(proxy, V8ClassIndex::HTMLHRELEMENT, impl);
