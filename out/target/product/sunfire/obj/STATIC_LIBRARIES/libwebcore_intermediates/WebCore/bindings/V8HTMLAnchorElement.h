...
class V8HTMLAnchorElement {
 ...
 public:
  ...
  static HTMLAnchorElement* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(HTMLAnchorElement*);
  ...
  v8::Handle<v8::Value> toV8(HTMLAnchorElement*);
  v8::Handle<v8::Value> toV8(PassRefPtr<HTMLAnchorElement >);
}
