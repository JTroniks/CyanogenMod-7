...
static const BatchedAttribute CompositionEvent_attrs[] = {
    {
        // Attribute 'data' (Type: 'readonly attribute' ExtAttr: '')
        "data",
        CompositionEventInternal::dataAttrGetter,
        0,
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8CompositionEventTemplate(v8::Persistent<v8::FunctionTemplate> desc) {
  v8::Local<v8::Signature> default_signature = configureTemplate(desc, "CompositionEvent",
      V8UIEvent::GetTemplate(), V8CompositionEvent::internalFieldCount,
      CompositionEvent_attrs, sizeof(CompositionEvent_attrs)/sizeof(*CompositionEvent_attrs),
      NULL, 0);
  ...
  const int initCompositionEvent_argc = 5;
  v8::Handle<v8::FunctionTemplate> initCompositionEvent_argv[initCompositionEvent_argc] = { v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>(), v8::Handle<v8::FunctionTemplate>(), V8DOMWindow::GetRawTemplate(), v8::Handle<v8::FunctionTemplate>() };
  v8::Handle<v8::Signature> initCompositionEvent_signature = v8::Signature::New(desc, initCompositionEvent_argc, initCompositionEvent_argv);
  proto->Set(v8::String::New("initCompositionEvent"), v8::FunctionTemplate::New(CompositionEventInternal::initCompositionEventCallback, v8::Handle<v8::Value>(), initCompositionEvent_signature));
...
v8::Persistent<v8::FunctionTemplate> V8CompositionEvent::GetRawTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8CompositionEvent_raw_cache_ = createRawTemplate();
  return V8CompositionEvent_raw_cache_;
}

v8::Persistent<v8::FunctionTemplate> V8CompositionEvent::GetTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8CompositionEvent_cache_ = ConfigureV8CompositionEventTemplate(GetRawTemplate());
  return V8CompositionEvent_cache_;
}
...
v8::Handle<v8::Object> V8CompositionEvent::wrap(CompositionEvent* impl) {
  ...
  if (!wrapper.IsEmpty())
    return wrapper;
  wrapper = V8DOMWrapper::instantiateV8Object(proxy, V8ClassIndex::COMPOSITIONEVENT, impl);
  if (wrapper.IsEmpty())
    return wrapper;
