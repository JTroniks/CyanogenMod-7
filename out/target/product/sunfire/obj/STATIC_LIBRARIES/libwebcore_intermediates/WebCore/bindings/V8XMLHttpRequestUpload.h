...
class V8XMLHttpRequestUpload {
 ...
 public:
  ...
  static XMLHttpRequestUpload* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(XMLHttpRequestUpload*);
  ...
  v8::Handle<v8::Value> toV8(XMLHttpRequestUpload*);
  v8::Handle<v8::Value> toV8(PassRefPtr<XMLHttpRequestUpload >);
}
