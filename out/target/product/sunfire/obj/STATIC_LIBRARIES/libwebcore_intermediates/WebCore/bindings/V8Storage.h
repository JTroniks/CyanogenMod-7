...
class V8Storage {
 ...
 public:
  ...
  static Storage* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(Storage*);
  ...
  v8::Handle<v8::Value> toV8(Storage*);
  v8::Handle<v8::Value> toV8(PassRefPtr<Storage >);
}
