...
static const BatchedAttribute WebGLActiveInfo_attrs[] = {
    {
        // Attribute 'size' (Type: 'readonly attribute' ExtAttr: '')
        "size",
        WebGLActiveInfoInternal::sizeAttrGetter,
        0,
    ...
    },
    {
        ...
        "type",
        WebGLActiveInfoInternal::typeAttrGetter,
        0,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
    ...
    },
    {
        ...
        "name",
        WebGLActiveInfoInternal::nameAttrGetter,
        0,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8WebGLActiveInfoTemplate(v8::Persistent<v8::FunctionTemplate> desc) {
  v8::Local<v8::Signature> default_signature = configureTemplate(desc, "WebGLActiveInfo",
      v8::Persistent<v8::FunctionTemplate>(), V8WebGLActiveInfo::internalFieldCount,
      WebGLActiveInfo_attrs, sizeof(WebGLActiveInfo_attrs)/sizeof(*WebGLActiveInfo_attrs),
      NULL, 0);
...
v8::Persistent<v8::FunctionTemplate> V8WebGLActiveInfo::GetTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8WebGLActiveInfo_cache_ = ConfigureV8WebGLActiveInfoTemplate(GetRawTemplate());
  return V8WebGLActiveInfo_cache_;
}
...
v8::Handle<v8::Object> V8WebGLActiveInfo::wrap(WebGLActiveInfo* impl) {
  ...
  if (!wrapper.IsEmpty())
    return wrapper;
  wrapper = V8DOMWrapper::instantiateV8Object(proxy, V8ClassIndex::WEBGLACTIVEINFO, impl);
  if (wrapper.IsEmpty())
    return wrapper;
