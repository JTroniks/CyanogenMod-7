...
class V8HTMLFrameSetElement {
 ...
 public:
  ...
  static HTMLFrameSetElement* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(HTMLFrameSetElement*);
  ...
  v8::Handle<v8::Value> toV8(HTMLFrameSetElement*);
  v8::Handle<v8::Value> toV8(PassRefPtr<HTMLFrameSetElement >);
}
