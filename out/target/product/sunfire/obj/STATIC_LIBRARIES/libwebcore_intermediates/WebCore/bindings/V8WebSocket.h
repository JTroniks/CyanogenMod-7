...
class V8WebSocket {
 ...
 public:
  ...
  static WebSocket* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(WebSocket*);
  ...
  v8::Handle<v8::Value> toV8(WebSocket*);
  v8::Handle<v8::Value> toV8(PassRefPtr<WebSocket >);
}
