...
class V8DocumentFragment {
 ...
 public:
  ...
  static DocumentFragment* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(DocumentFragment*, bool forceNewObject = false);
  ...
  v8::Handle<v8::Value> toV8(DocumentFragment*, bool forceNewObject = false);
  v8::Handle<v8::Value> toV8(PassRefPtr<DocumentFragment >, bool forceNewObject = false);
}
