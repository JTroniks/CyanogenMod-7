...
static const BatchedAttribute HTMLDocument_attrs[] = {
    {
        // Attribute 'embeds' (Type: 'readonly attribute' ExtAttr: '')
        "embeds",
        HTMLDocumentInternal::embedsAttrGetter,
        0,
    ...
    },
    {
        ...
        "plugins",
        HTMLDocumentInternal::pluginsAttrGetter,
        0,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
    ...
    },
    {
        ...
        "scripts",
        HTMLDocumentInternal::scriptsAttrGetter,
        0,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
    ...
    },
    {
        ...
        "all",
        V8HTMLDocument::allAccessorGetter,
    ...
    },
    {
        ...
        "width",
        HTMLDocumentInternal::widthAttrGetter,
        0,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
    ...
    },
    {
        ...
        "height",
        HTMLDocumentInternal::heightAttrGetter,
        0,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
    ...
    },
    {
        ...
        "dir",
        HTMLDocumentInternal::dirAttrGetter,
        HTMLDocumentInternal::dirAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "designMode",
        HTMLDocumentInternal::designModeAttrGetter,
        HTMLDocumentInternal::designModeAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "compatMode",
        HTMLDocumentInternal::compatModeAttrGetter,
        0,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
    ...
    },
    {
        ...
        "activeElement",
        HTMLDocumentInternal::activeElementAttrGetter,
        0,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
    ...
    },
    {
        ...
        "bgColor",
        HTMLDocumentInternal::bgColorAttrGetter,
        HTMLDocumentInternal::bgColorAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "fgColor",
        HTMLDocumentInternal::fgColorAttrGetter,
        HTMLDocumentInternal::fgColorAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "alinkColor",
        HTMLDocumentInternal::alinkColorAttrGetter,
        HTMLDocumentInternal::alinkColorAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "linkColor",
        HTMLDocumentInternal::linkColorAttrGetter,
        HTMLDocumentInternal::linkColorAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
    },
    {
        ...
        "vlinkColor",
        HTMLDocumentInternal::vlinkColorAttrGetter,
        HTMLDocumentInternal::vlinkColorAttrSetter,
        V8ClassIndex::INVALID_CLASS_INDEX /* no data */,
        static_cast<v8::AccessControl>(v8::DEFAULT),
        static_cast<v8::PropertyAttribute>(v8::None),
        0 /* on instance */
...
static const BatchedCallback HTMLDocument_callbacks[] = {
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8HTMLDocumentTemplate(v8::Persistent<v8::FunctionTemplate> desc) {
  v8::Local<v8::Signature> default_signature = configureTemplate(desc, "HTMLDocument",
      V8Document::GetTemplate(), V8HTMLDocument::internalFieldCount,
      HTMLDocument_attrs, sizeof(HTMLDocument_attrs)/sizeof(*HTMLDocument_attrs),
      HTMLDocument_callbacks, sizeof(HTMLDocument_callbacks)/sizeof(*HTMLDocument_callbacks));
  v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
  v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
  
  desc->InstanceTemplate()->SetIndexedPropertyHandler(V8HTMLDocument::indexedPropertyGetter, 0, 0, 0);
  desc->InstanceTemplate()->SetNamedPropertyHandler(V8HTMLDocument::namedPropertyGetter, 0, 0, V8HTMLDocument::namedPropertyDeleter, 0);
...
v8::Persistent<v8::FunctionTemplate> V8HTMLDocument::GetRawTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLDocument_raw_cache_ = createRawTemplate();
  return V8HTMLDocument_raw_cache_;
}

v8::Persistent<v8::FunctionTemplate> V8HTMLDocument::GetTemplate() {
  static v8::Persistent<v8::FunctionTemplate> V8HTMLDocument_cache_ = ConfigureV8HTMLDocumentTemplate(GetRawTemplate());
  return V8HTMLDocument_cache_;
}
...
v8::Handle<v8::Object> V8HTMLDocument::wrap(HTMLDocument* impl, bool forceNewObject) {
  ...
  if (!context.IsEmpty())
    context->Enter();
  wrapper = V8DOMWrapper::instantiateV8Object(proxy, V8ClassIndex::HTMLDOCUMENT, impl);
