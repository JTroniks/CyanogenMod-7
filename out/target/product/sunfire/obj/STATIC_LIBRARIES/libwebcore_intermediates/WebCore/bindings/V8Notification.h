...
class V8Notification {
 ...
 public:
  ...
  static Notification* toNative(v8::Handle<v8::Object>);
  static v8::Handle<v8::Object> wrap(Notification*);
  static v8::Handle<v8::Value> showCallback(const v8::Arguments&);
  static v8::Handle<v8::Value> cancelCallback(const v8::Arguments&);
  ...
  v8::Handle<v8::Value> toV8(Notification*);
  v8::Handle<v8::Value> toV8(PassRefPtr<Notification >);
}
